...
SECRET_KEY = 'django-insecure-b^ho@wqpvb5c*5v%@3ycaz9cex=(u9jco=9!&-rd5so2p^_dq0'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'theme' / 'templates'],  # Add this line to include project-level templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
